    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-16">
        <motion.div
          ...
          className="w-full max-w-5xl rounded-[32px] border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl sm:p-10"
        >
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <button
              ...
              className="group rounded-3xl border border-white/10 bg-white/10 p-8 text-left transition-all duration-300 hover:-translate-y-1 hover:border-blue-400/40 hover:bg-white/15"
            >
              ...
              <div className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-blue-300">
            ...
            <button
              ...
              className="group rounded-3xl border border-white/10 bg-white/10 p-8 text-left transition-all duration-300 hover:-translate-y-1 hover:border-purple-400/40 hover:bg-white/15"
            >
              ...
              <h2 className="mt-6 text-2xl font-semibold text-white">Teacher</h2>
              <p className="mt-3 text-sm leading-7 text-slate-400">
                Lead classes, review assignments, and keep students on track from your dedicated teacher portal.
              </p>
              <div className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-purple-300">
